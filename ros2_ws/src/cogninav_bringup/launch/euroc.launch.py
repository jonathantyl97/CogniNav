...
def generate_launch_description() -> LaunchDescription:
    ...
    euroc_params = PathJoinSubstitution([pkg, "config", "euroc.yaml"])
    ...
    return LaunchDescription(
        [
            DeclareLaunchArgument("seq", default_value="MH_01_easy"),
            DeclareLaunchArgument(
                "bag_path",
                default_value="/root/Downloads/euroc/MH_01_easy.bag",
                description="Override with bag_path:=/path/to/seq.bag",
            ),
            ...
            Node(
                ...
                name="cogninav_vslam",
                parameters=[euroc_params, {"use_sim_time": use_sim_time}],
                output="screen",
            ),
            ExecuteProcess(
                cmd=[
